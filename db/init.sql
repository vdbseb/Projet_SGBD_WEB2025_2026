...
CREATE TABLE public.paiement (
                                 ...
                                 participation_match_id integer,
...
--
-- Name: dette_membre; Type: TABLE; Schema: public; Owner: padel_app
--
...
ALTER TABLE public.dette_membre OWNER TO padel_app;

ALTER TABLE public.dette_membre ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.dette_membre_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.reservation (
                                    ...
                                    statut character varying(50) NOT NULL DEFAULT 'EN_ATTENTE_PAIEMENT'
);
...
VALUES
    ...
    (5, 'AS05', 4, 'SITE', 'Admin', 'Namur', 'admin.namur@padel.be');
...
INSERT INTO public.horaire_site VALUES (2026, 90, '07:30:00', '22:30:00', 4, 15, 4);
INSERT INTO public.horaire_site VALUES (2027, 90, '08:00:00', '22:00:00', 5, 15, 1);
...
INSERT INTO public.jour_fermeture VALUES (7, 4, '2026-09-27', 'Fermeture exceptionnelle Namur', false);
INSERT INTO public.jour_fermeture VALUES (8, NULL, '2027-01-01', 'Nouvel an', true);
...
INSERT INTO public.match_padel VALUES ('2026-06-20', '09:00:00', '10:30:00', 44, 11, 60, 7, 48, '2026-05-26 09:00:00', 'OUVERT', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-20', '11:00:00', '12:30:00', 45, 11, 60, 7, 49, '2026-05-26 09:10:00', 'OUVERT', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-20', '14:00:00', '15:30:00', 46, 12, 60, 8, 50, '2026-05-26 09:20:00', 'ANNULE', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-21', '10:00:00', '11:30:00', 47, 3, 60, 10, 51, '2026-05-26 09:30:00', 'COMPLET', 'PRIVE');
INSERT INTO public.match_padel VALUES ('2026-05-20', '18:00:00', '19:30:00', 48, 4, 60, 2, 52, '2026-05-19 09:30:00', 'TERMINE', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-22', '18:00:00', '19:30:00', 49, 13, 60, 5, 53, '2026-05-26 10:00:00', 'OUVERT', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-23', '16:00:00', '17:30:00', 50, 14, 60, 10, 55, '2026-05-26 10:30:00', 'ANNULE', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-24', '19:00:00', '20:30:00', 51, 15, 60, 1, 56, '2026-05-26 11:00:00', 'ANNULE', 'PUBLIC');
INSERT INTO public.match_padel VALUES ('2026-06-25', '09:30:00', '11:00:00', 52, 16, 60, 3, 57, '2026-05-26 11:30:00', 'OUVERT', 'PUBLIC');
...
INSERT INTO public.membre VALUES (true, 11, 4, 2, 'lea.fontaine@mail.com', 'S0005', 'Fontaine', 'Lea');
INSERT INTO public.membre VALUES (true, 12, 4, 2, 'tom.vermeulen@mail.com', 'S0006', 'Vermeulen', 'Tom');
INSERT INTO public.membre VALUES (true, 13, NULL, 3, 'ines.laurent@mail.com', 'L0004', 'Laurent', 'Ines');
INSERT INTO public.membre VALUES (true, 14, NULL, 3, 'yanis.michel@mail.com', 'L0005', 'Michel', 'Yanis');
INSERT INTO public.membre VALUES (true, 15, 1, 2, 'mila.dubois@mail.com', 'S0007', 'Dubois', 'Mila');
INSERT INTO public.membre VALUES (true, 16, 2, 2, 'adam.rossi@mail.com', 'S0008', 'Rossi', 'Adam');
INSERT INTO public.membre VALUES (false, 17, 4, 2, 'inactive.test@mail.com', 'S0099', 'Inactive', 'Test');
INSERT INTO public.membre VALUES (true, 18, NULL, 1, 'global.test@mail.com', 'G0004', 'Global', 'Test');
...
VALUES
    ...
    (7, 10, 1, 11, 1500, 'EUR', 'MOCK', 'mock_pi_seed_10', NULL, 'CARTE', 'VALIDE', '2026-05-24 12:00:00', '2026-05-24 12:01:00', NULL, '{"scenario": "seed prive complet"}'),
    (8, 11, 1, 15, 1500, 'EUR', 'MOCK', 'mock_pi_seed_11', NULL, 'CARTE', 'VALIDE', '2026-05-24 17:05:50', '2026-05-24 17:06:30', NULL, '{"scenario": "seed public ouvert"}');
...
(id, match_id, membre_id, date_inscription)
VALUES
    (11, 6, 1, NULL),
    (12, 6, 8, NULL),
    (13, 6, 2, NULL),
    (14, 6, 7, NULL),
    (15, 7, 1, NULL),
    (16, 8, 1, '2026-05-24 17:41:39.843953'),
    (49, 41, 2, '2026-05-25 10:56:53.60138'),
    (50, 42, 1, '2026-05-25 11:11:21.568594'),
    (51, 43, 1, '2026-05-25 11:22:37.192044'),
...
--
-- Data for Name: dette_membre; Type: TABLE DATA; Schema: public; Owner: padel_app
--
...
VALUES
    ...
    (2, 18, NULL, NULL, 3000, 'OUVERTE', 'SOLDE_ORGANISATEUR', '2026-05-27 11:00:00', NULL),
...
(court_id, date, end_time, id, membre_id, start_time, statut)
VALUES
    (1, '2026-05-30', '14:00:00', 10, 1, '12:30:00', 'VALIDEE'),
    (1, '2026-05-30', '16:30:00', 11, 1, '15:00:00', 'VALIDEE'),
    (4, '2026-05-26', '15:30:00', 12, 1, '14:00:00', 'TERMINEE'),
    (3, '2026-06-08', '12:30:00', 45, 2, '11:00:00', 'VALIDEE'),
    (4, '2026-06-02', '14:00:00', 46, 1, '12:30:00', 'VALIDEE'),
    (6, '2026-06-15', '11:30:00', 47, 1, '10:00:00', 'VALIDEE'),
    ...
    (8, '2026-06-23', '09:00:00', 54, 12, '07:30:00', 'ANNULEE'),
...
--
INSERT INTO public.site VALUES (true, 4, 'Avenue des Tests 12', '5000', 'Site de test avec plusieurs terrains pour les scenarios Postman.', 'images/namur.jpg', 'NAMUR TEST PADEL', 'NAMUR');
...
(actif, couvert, maintenance, id, site_id, nom)
VALUES
    (true, true, false, 1, 1, 'B1'),
    (true, false, true, 2, 1, 'B2-MAINTENANCE'),
    (true, true, false, 3, 2, 'L1'),
    (true, false, false, 4, 2, 'L2'),
    (true, true, false, 5, 3, 'A1'),
    (true, false, false, 6, 3, 'A2'),
    (true, true, false, 7, 4, 'N1'),
    (true, false, true, 8, 4, 'N2-MAINTENANCE'),
    (false, true, false, 9, 4, 'N3-INACTIF'),
    (true, true, false, 10, 1, 'B3');
...
--
-- Données historiques supplémentaires pour les vues admin/statistiques.
-- Objectif : avoir un historique mensuel, du CA net, des remboursements et des maintenances visibles après un reset complet Docker.
--

INSERT INTO public.reservation
(court_id, date, end_time, id, membre_id, start_time, statut)
VALUES
    (1, '2026-01-12', '19:30:00', 70, 1, '18:00:00', 'TERMINEE'),
    (3, '2026-01-15', '20:30:00', 71, 5, '19:00:00', 'TERMINEE'),
    (7, '2026-02-02', '11:00:00', 72, 11, '09:30:00', 'TERMINEE'),
    (10, '2026-02-14', '12:30:00', 73, 3, '11:00:00', 'TERMINEE'),
    (5, '2026-03-03', '18:30:00', 74, 13, '17:00:00', 'TERMINEE'),
    (6, '2026-03-10', '19:30:00', 75, 18, '18:00:00', 'ANNULEE'),
    (4, '2026-04-05', '16:30:00', 76, 1, '15:00:00', 'TERMINEE'),
    (2, '2026-04-12', '17:30:00', 77, 4, '16:00:00', 'ANNULEE'),
    (8, '2026-04-20', '10:30:00', 78, 12, '09:00:00', 'ANNULEE'),
    (1, '2026-05-05', '20:30:00', 79, 2, '19:00:00', 'TERMINEE'),
    (3, '2026-05-18', '11:30:00', 80, 16, '10:00:00', 'TERMINEE');

INSERT INTO public.match_padel
(date_match, heure_debut, heure_fin, id, organisateur_id, prix_total, terrain_id, reservation_id, created_at, statut, type_match)
VALUES
    ('2026-01-12', '18:00:00', '19:30:00', 60, 1, 60, 1, 70, '2026-01-05 09:00:00', 'TERMINE', 'PUBLIC'),
    ('2026-01-15', '19:00:00', '20:30:00', 61, 5, 60, 3, 71, '2026-01-07 10:00:00', 'TERMINE', 'PUBLIC'),
    ('2026-02-02', '09:30:00', '11:00:00', 62, 11, 60, 7, 72, '2026-01-25 11:00:00', 'TERMINE', 'PUBLIC'),
    ('2026-02-14', '11:00:00', '12:30:00', 63, 3, 60, 10, 73, '2026-02-01 12:00:00', 'TERMINE', 'PRIVE'),
    ('2026-03-03', '17:00:00', '18:30:00', 64, 13, 60, 5, 74, '2026-02-20 13:00:00', 'TERMINE', 'PUBLIC'),
    ('2026-03-10', '18:00:00', '19:30:00', 65, 18, 60, 6, 75, '2026-02-25 14:00:00', 'ANNULE', 'PUBLIC'),
    ('2026-04-05', '15:00:00', '16:30:00', 66, 1, 60, 4, 76, '2026-03-20 10:30:00', 'TERMINE', 'PUBLIC'),
    ('2026-04-12', '16:00:00', '17:30:00', 67, 4, 60, 2, 77, '2026-04-01 08:30:00', 'ANNULE', 'PUBLIC'),
    ('2026-04-20', '09:00:00', '10:30:00', 68, 12, 60, 8, 78, '2026-04-04 09:30:00', 'ANNULE', 'PUBLIC'),
    ('2026-05-05', '19:00:00', '20:30:00', 69, 2, 60, 1, 79, '2026-04-18 12:00:00', 'TERMINE', 'PUBLIC'),
    ('2026-05-18', '10:00:00', '11:30:00', 70, 16, 60, 3, 80, '2026-05-02 15:00:00', 'TERMINE', 'PUBLIC');
...
VALUES
    ...
    (22, 72, 11, 82, 1500, 'EUR', 'MOCK', 'mock_hist_feb_72', NULL, 'CARTE', 'VALIDE', '2026-01-25 11:02:00', '2026-01-25 11:03:00', NULL, '{"scenario": "historique fevrier Namur"}'),
    (23, 73, 3, 83, 1500, 'EUR', 'MOCK', 'mock_hist_feb_73_1', NULL, 'CARTE', 'VALIDE', '2026-02-01 12:05:00', '2026-02-01 12:06:00', NULL, '{"scenario": "match prive historique"}'),
    (24, 73, 4, 84, 1500, 'EUR', 'MOCK', 'mock_hist_feb_73_2', NULL, 'CARTE', 'VALIDE', '2026-02-01 12:07:00', '2026-02-01 12:08:00', NULL, '{"scenario": "match prive historique"}'),
    (25, 73, 15, 85, 1500, 'EUR', 'MOCK', 'mock_hist_feb_73_3', NULL, 'CARTE', 'VALIDE', '2026-02-01 12:09:00', '2026-02-01 12:10:00', NULL, '{"scenario": "match prive historique"}'),
    (26, 73, 18, 86, 1500, 'EUR', 'MOCK', 'mock_hist_feb_73_4', NULL, 'CARTE', 'VALIDE', '2026-02-01 12:11:00', '2026-02-01 12:12:00', NULL, '{"scenario": "match prive historique"}'),
...
SELECT setval(
               pg_get_serial_sequence('public.dette_membre', 'id'),
               (SELECT COALESCE(MAX(id), 1) FROM public.dette_membre),
               true
       );
...
--
-- Name: dette_membre dette_membre_pkey; Type: CONSTRAINT; Schema: public; Owner: padel_app
--

ALTER TABLE ONLY public.dette_membre
    ADD CONSTRAINT dette_membre_pkey PRIMARY KEY (id);


--
-- Name: paiement paiement_provider_payment_id_key; Type: INDEX; Schema: public; Owner: padel_app
--
...
--
-- Name: reservation reservation_statut_check; Type: CONSTRAINT; Schema: public; Owner: padel_app
--
...
--
-- Name: paiement fk_paiement_membre; Type: FK CONSTRAINT; Schema: public; Owner: padel_app
--
...
--
-- Name: paiement fk_paiement_reservation; Type: FK CONSTRAINT; Schema: public; Owner: padel_app
--
...
--
-- Name: dette_membre fk_dette_membre_membre; Type: FK CONSTRAINT; Schema: public; Owner: padel_app
--

ALTER TABLE ONLY public.dette_membre
    ADD CONSTRAINT fk_dette_membre_membre FOREIGN KEY (membre_id) REFERENCES public.membre(id);

ALTER TABLE ONLY public.dette_membre
    ADD CONSTRAINT fk_dette_membre_participation FOREIGN KEY (participation_id) REFERENCES public.participation(id);
